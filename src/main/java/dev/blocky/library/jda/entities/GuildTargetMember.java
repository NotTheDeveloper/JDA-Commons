...
public class GuildTargetMember {
    ...
    private GuildTargetMember(@NotNull UserContextInteractionEvent userEvent) {
        ...
        if(JDALogger.SLF4J_ENABLED) {
            ...
            if (userEvent == null) {
                logger.error("The User Context Interaction you specify equals null.", new NullPointerException());
            }
        }
    }
    ...
    private GuildTargetMember(@NotNull MessageContextInteractionEvent messageEvent) {
        ...
        if(JDALogger.SLF4J_ENABLED) {
            ...
            if (messageEvent == null) {
                logger.error("The Message Context Interaction you specify equals null.", new NullPointerException());
            }
        }
    }
    ...
    /**
     * Checks if the {@link UserContextInteractionEvent#getTargetMember() Target Member}
     * has the {@link Role Role} with the ID you specified.
     *
     * @param roleId The ID of the {@link Role Role}, which should be checked
     * @return <b>null</b> If the {@link UserContextInteractionEvent#getTargetMember() Target Member} has not the {@link Role Role}
     */
    @Nullable
     ...
     *
     * @param roleId The ID of the {@link Role Role}, which should be checked
     * @return <b>true</b> If the {@link UserContextInteractionEvent#getTargetMember() Target Member} has the {@link Role Role} <br>
     * <b>false</b> If the {@link UserContextInteractionEvent#getTargetMember() Target Member} has not the {@link Role Role}
     */
    ...
    /**
     * Checks if the {@link UserContextInteractionEvent#getTargetMember() Target Member}
     * has the {@link Role Role} with the name you specified.
     *
     ...
     *
     * @return <b>true</b> If the {@link UserContextInteractionEvent#getTargetMember() Target Member} is boosting the server <br>
     * <b>false</b> If the {@link UserContextInteractionEvent#getTargetMember() Target Member} is not boosting the server
     */
