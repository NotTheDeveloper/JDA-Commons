...
/**
 * Represents a Discord text {@link GuildChannel guild channel}.
 *
 * @author BlockyDotJar
 * @version v2.1.4
...
{
    private static final Logger logger = JDALogger.getLog(GuildTextChannel.class);
    private final MessageChannelUnion union;
    private final TextChannel channel;
    private Member member;

    private GuildTextChannel(@NotNull MessageChannelUnion union, @Nullable Member member)
    {
        this.channel = union.asTextChannel();
        this.union = union;
        this.member = member;
    ...
    private GuildTextChannel(@NotNull MessageChannelUnion union)
    {
        this.channel = union.asTextChannel();
        this.union = union;
    ...
    /**
     * Constructs a <b>new</b> {@link GuildTextChannel} instance.
     * <br>If you don't initialize a {@link MessageChannelUnion} or a {@link Member},
     * the {@link GuildTextChannel} always will be <b>null</b>.
     *
     ...
     *
     * @return A <b>new</b> {@link GuildTextChannel} instance.
     */
    @NotNull
    public static GuildTextChannel set(@NotNull MessageChannelUnion union, @Nullable Member member)
    {
        return new GuildTextChannel(union, member);
    }
     ...
     */
    @NotNull
    public static GuildTextChannel set(@NotNull MessageChannelUnion union)
    {
        return new GuildTextChannel(union);
    }
    ...
    /**
     * The {@link TextChannel} for this {@link Message}.
     *
    ...
    /**
     * Convenience method to delete a complete {@link TextChannel} in the most efficient way available.
     * <br>No checks will be done to prevent failures, use {@link CompletionStage#exceptionally(Function)} to handle failures.
     *
     * @param clear The {@link SafetyClear} option, which helps for specifying different message types, which will not be deleted.
     *
