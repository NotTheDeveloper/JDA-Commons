...
public class GuildTextChannel extends Utility
{
     ...
     * <br>If you don't initialize a {@link TextChannel text channel} or a {@link Member member},
    ...
    /**
     * Gets all the messages from the user, which was specified with the {@link #set(TextChannel, Member)} method,
