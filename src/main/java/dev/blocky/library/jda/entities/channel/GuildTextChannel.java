...
public class GuildTextChannel extends Utility
{
     ...
     * <br>If you don't initialize a {@link TextChannel} or a {@link Member},
    ...
    /**
     * Constructs a <b>new</b> {@link GuildTextChannel} instance.
     * <br>If you don't initialize a {@link TextChannel},
     * the {@link GuildTextChannel} always will be <b>null</b>.
     *
     * @param channel The {@link TextChannel}, which should be initialized.
     *
    ...
    /**
     * Gets all the messages from the {@link User}, which was specified with the {@link #set(TextChannel, Member)} method,
