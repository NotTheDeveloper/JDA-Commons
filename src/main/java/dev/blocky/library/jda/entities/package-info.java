 ...
 *
 * <ul>
 * <li>{@link dev.blocky.library.jda.entities.GuildMember GuildMember} <br>
 * Represents a Guild-specific {@link net.dv8tion.jda.api.entities.User User}. <li>
 * <p>
 * {@link dev.blocky.library.jda.entities.GuildTextChannel GuildTextChannel} <br>
 * Represents a Discord Text {@link net.dv8tion.jda.api.entities.GuildChannel GuildChannel}. </li>
 *
 * <li>{@link dev.blocky.library.jda.entities.GuildMessageChannel GuildTextChannel} <br>
