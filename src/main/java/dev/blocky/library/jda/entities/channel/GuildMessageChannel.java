...
public class GuildMessageChannel extends Utility
{
     ...
     * <br>If you don't initialize a {@link MessageChannel} or a {@link Member},
    ...
    /**
     * Constructs a <b>new</b> {@link GuildMessageChannel} instance.
     * <br>If you don't initialize a {@link MessageChannel},
     * the {@link GuildMessageChannel} always will be <b>null</b>.
     *
     * @param channel The {@link MessageChannel}, which  should be initialized.
     *
    ...
    /**
     * Gets all the messages from the {@link User}, which was specified with the {@link #set(MessageChannel, Member)} method,
