...
/**
 * Represents a Discord channel that can have {@link Message messages}
...
public class GuildMessageChannel extends Utility
{
     ...
     * <br>If you don't initialize a {@link MessageChannel message channel} or a {@link Member member},
    ...
    /**
     * Constructs a <b>new</b> {@link GuildMessageChannel guild message channel} instance.
     * <br>If you don't initialize a {@link MessageChannel message channel},
     * the {@link GuildMessageChannel guild message channel} always will be <b>null</b>.
     *
     * @param channel The {@link MessageChannel message channel}, which  should be initialized
     *
