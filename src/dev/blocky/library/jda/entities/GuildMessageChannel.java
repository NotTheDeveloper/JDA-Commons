...
public class GuildMessageChannel {
    ...
    /**
     * Constructs a <b>new</b> {@link dev.blocky.library.jda.entities.GuildMessageChannel Guild Message Channel} instance. If you don't
     ...
     * {@link dev.blocky.library.jda.entities.GuildMessageChannel Guild Message Channel} always will be <b>null</b>.
     *
     ...
     *                should be initialized.
     */
    public GuildMessageChannel(MessageChannel channel, Member member) {
     ...
     *                should be initialized.
     */
    public GuildMessageChannel(MessageChannel channel) {
        this.channel = channel;
